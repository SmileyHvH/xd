...
const char *opt_Chams[] = { "Textured", "Textured XQZ", "Flat", "Flat XQZ", "Wireframe", "Colored"};
const char *opt_Hitsounds[] = { "Gamesense" };

const char *opt_AimHitboxSpot[] = { "Head", "Neck", "Body", "Pelvis" , "Max"};
...
const char *opt_worldmod[] = { "Off", "Snow", "LSD", "Chrome", "Smileymode (Mc)"};

const char *opt_AApitch[] = { "Off", "Dynamic", "Emotion (Down)", "Straight", "Up" };
const char *opt_AAyaw[] = { "Off", "Backwards", "Backwards Jitter", "Keybased", "Keybased Jitter", "WeirdDesyncButOkey" };
const char *opt_AAfakeyaw[] = { "Off", "180", "Crooked", "ManualCrooked", "CorruptionCrooked", "CorruptionCrooked+Slider", "ManualCrookedCorupption" };

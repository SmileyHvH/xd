...
unsigned long __stdcall Installer::installGladiator(void *unused)
{
	...
	Utils::ConsolePrint(true, "Exodia loaded\n");
	...
	o_CreateMove = g_pClientModeHook->GetOriginal<CreateMove_t>(22);
	...
	Utils::ConsolePrint(true, "Exodia was successfully initialized!\n");

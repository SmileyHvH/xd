...
bool C_BaseCombatWeapon::IsMiscellaneousWeapon()
{
	...
	return
		(iWeaponID == WEAPON_KNIFE_CT || iWeaponID == WEAPON_C4
			...
			|| iWeaponID == WEAPON_KNIFE_HUNTSMAN || iWeaponID == WEAPON_KNIFE_BUTTERFLY);
}
...
bool C_BaseCombatWeapon::IsWeaponNonAim()
{
	...
	return (idx == WEAPON_C4 || idx == WEAPON_KNIFE || idx == WEAPON_KNIFE_BAYONET || idx == WEAPON_KNIFE_BUTTERFLY || idx == WEAPON_KNIFE_FALCHION || idx == WEAPON_KNIFE_CT
		|| idx == WEAPON_KNIFE_FLIP || idx == WEAPON_KNIFE_GUT || idx == WEAPON_KNIFE_KARAMBIT || idx == WEAPON_KNIFE_M9_BAYONET || idx == WEAPON_KNIFE_DAGGER
		|| idx == WEAPON_KNIFE_SURVIVAL_BOWIE || idx == WEAPON_KNIFE_T || idx == WEAPON_KNIFE_HUNTSMAN || idx == WEAPON_FLASHBANG || idx == WEAPON_HEGRENADE

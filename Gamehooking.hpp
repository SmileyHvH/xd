...
/* SendDatagram defs */
typedef int(__thiscall *SendDatagram_t)(INetChannel*, bf_write*);
...
namespace Handlers
{
	...
	int __fastcall SendDatagram_h(INetChannel *ECX, void *EDX, bf_write *data);
